...
which can be used to assign a traffic class to every frame. The field is called
...
frames of this particular flow is installed to the hardware. From now on, the traffic from the
